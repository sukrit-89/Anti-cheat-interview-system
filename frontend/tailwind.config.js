        ...
        extend: {
            colors: {
                ...
                bronze: {
                    ...
                    light:   '#E09848',
                    dark:    '#B06A28',
                    muted:   'rgba(212,135,63,0.18)',
                    glow:    'rgba(212,135,63,0.35)',
                },
                status: {
                    critical:      '#F04848',
            ...
            keyframes: {
                ...
                glowPulse: {
                    '0%, 100%': { boxShadow: '0 0 12px rgba(212,135,63,0.35)' },
                    '50%':      { boxShadow: '0 0 28px rgba(212,135,63,0.55)' },
                },
                float: {
            ...
            boxShadow: {
                ...
                'glow':         '0 0 28px rgba(212,135,63,0.22)',
                'glow-strong':  '0 0 48px rgba(212,135,63,0.35)',
                'inner-glow':   'inset 0 1px 0 rgba(255,255,255,0.06)',
                'card':         '0 2px 6px rgba(0,0,0,0.4), 0 0 0 1px rgba(255,255,255,0.03)',
                'card-hover':   '0 8px 30px rgba(0,0,0,0.6), 0 0 0 1px rgba(212,135,63,0.18)',
                'dialog':       '0 25px 60px -12px rgba(0,0,0,0.8)',
                'bronze':       '0 0 20px -5px rgba(212,135,63,0.55)',
                'bronze-strong':'0 0 28px rgba(212,135,63,0.45)',
            },
            backdropBlur: {
                'xs': '2px',
                '2xl': '40px',
