...
function App() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-x-hidden bg-[#0b1120]">
      {/* Test div to verify CSS is working */}
      <div className="test-bg absolute top-4 left-4 z-[100]"></div>
      ...
      <div className="relative z-50 min-h-screen">
        <div className="h-screen flex flex-col p-4 md:p-6 gap-4">
