...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'btn-authority inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none';
  
  const variantClasses = {
    primary: 'btn-authority-primary',
